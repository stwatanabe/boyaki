...
var apiBoyakiGqlGraphQLAPIIdOutput = process.env.API_BOYAKIGQL_GRAPHQLAPIIDOUTPUT
var apiBoyakiGqlGraphQLAPIEndpointOutput = process.env.API_BOYAKIGQL_GRAPHQLAPIENDPOINTOUTPUT
...
exports.handler = async (event, context, callback) => {
    ...
    if ('AWS_EXECUTION_ENV' in process.env && process.env.AWS_EXECUTION_ENV.startsWith('AWS_Lambda_')) {
        ...
        // for local mock
        env = {
            API_BOYAKIGQL_GRAPHQLAPIENDPOINTOUTPUT: 'http://192.168.1.26:20002/graphql',
            REGION: 'us-east-1',
        }
        graphql_auth = {
            type: "AWS_IAM",
